        ...
        <div class="tab-content">
              ...
              <div class="especialidades-grid">
                ...
                >
                  ...
                  <div class="especialidad-actions">
                    <button
                      (click)="toggleEspecialidadEstado(especialidad)"
                      class="btn-toggle"
                    >
          ...
          <div *ngIf="pestanaActiva === 'doctores'" class="tab-panel">
            ...
            <div class="content-section" *ngIf="doctoresFiltrados.length > 0">
              <h3>
                👨‍⚕️ Doctores Encontrados ({{ doctoresFiltrados.length }}/{{
                  doctores.length
                }})
              </h3>
              <div class="doctores-grid">
                ...
                >
                  <div class="doctor-header">
                    ...
                    <span
                      class="estado"
                      [class.activo]="doctor.estado === 'ACTIVO'"
                    >
                      {{
                  ...
                  <div class="doctor-info">
                    ...
                    <p>
                      <strong>🆔 Licencia:</strong> {{ doctor.numeroLicencia }}
                    </p>
                  </div>
                  <div class="doctor-actions">
                    <button
                      (click)="toggleDoctorEstado(doctor)"
                      class="btn-toggle"
                    >
                      {{
            ...
            <div
              *ngIf="doctoresFiltrados.length === 0 && doctores.length > 0"
              class="no-results"
            >
            ...
            <div class="form-container">
              <form (ngSubmit)="agregarDoctor()" class="form">
                ...
                <div class="form-group">
                  ...
                  <small
                    class="form-hint"
                    *ngIf="nuevoDoctor.correo && !correoDuplicado"
                  >
                    ✅ Correo disponible
                  </small>
                </div>
                <div class="form-group">
                  ...
                  <small class="password-hint"
                    >Mínimo 6 caracteres. El doctor usará esta contraseña para
                ...
                <div class="form-group">
                  ...
                  <small class="form-hint">
                    💡 Puede ingresar solo números, se formateará
                    automáticamente
                  </small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <small
                    class="form-hint"
                    *ngIf="nuevoDoctor.numeroLicencia && !licenciaDuplicada"
                  >
                    ✅ Número de licencia disponible
                  </small>
                  <small class="form-hint">
                    💡 Si ingresa solo números, se agregará automáticamente el
                    prefijo "LIC-"
                  </small>
                </div>
                <button
          ...
          <div *ngIf="pestanaActiva === 'reportes'" class="tab-panel">
            ...
            <div class="reportes-resultados" *ngIf="reporteActual">
              ...
              <!-- Reporte General -->
              <div
                *ngIf="reporteActual.tipo === 'general'"
                class="reporte-general"
              >
                <div class="stats-reporte">
                  <div class="stat-reporte">
                    <h4>👥 Total Usuarios</h4>
                    <span class="numero-stat">{{
                      reporteActual.datos.totalUsuarios
                    }}</span>
                  </div>
                  <div class="stat-reporte">
                    <h4>👨‍⚕️ Total Doctores</h4>
                    <span class="numero-stat">{{
                      reporteActual.datos.totalDoctores
                    }}</span>
                  </div>
                  <div class="stat-reporte">
                    <h4>✅ Doctores Activos</h4>
                    <span class="numero-stat">{{
                      reporteActual.datos.doctoresActivos
                    }}</span>
                  </div>
                  <div class="stat-reporte">
                    <h4>🏥 Especialidades</h4>
                    <span class="numero-stat">{{
                      reporteActual.datos.totalEspecialidades
                    }}</span>
                  </div>
                </div>
                ...
                <div class="grafico-placeholder">
                  ...
                  <div class="especialidades-chart">
                    <div
                      *ngFor="
                        let esp of reporteActual.datos.especialidadesStats
                      "
                      class="chart-bar"
                    >
                      ...
                      <div class="bar-container">
                        <div
                          class="bar-fill"
                          [style.width.%]="
                            (esp.doctores / reporteActual.datos.totalDoctores) *
                            100
                          "
                        >
                          {{ esp.doctores }}
              ...
              <!-- Reporte de Doctores -->
              <div
                *ngIf="reporteActual.tipo === 'doctores'"
                class="reporte-doctores"
              >
                <div class="tabla-reporte">
                  <table class="tabla-doctores">
                    ...
                    <tbody>
                      <tr
                        *ngFor="let doctor of reporteActual.datos"
                        [class.inactivo]="doctor.estado !== 'ACTIVO'"
                      >
                        <td>{{ doctor.nombre }}</td>
              ...
              <div
                *ngIf="reporteActual.tipo === 'estadisticas'"
                class="reporte-estadisticas"
              >
                <div class="stats-grid-reporte">
                  <div class="stat-card-reporte">
                    <h4>📊 Especialidad Más Popular</h4>
                    <p class="stat-valor">
                      {{ reporteActual.datos.especialidadMasPopular.nombre }}
                    </p>
                    <small
                      >{{
                        reporteActual.datos.especialidadMasPopular.cantidad
                      }}
                      doctores</small
                    >
                  </div>
                  <div class="stat-card-reporte">
                    ...
                    <p class="stat-valor">
                      {{
                        reporteActual.datos.promedioDoctoresPorEspecialidad
                          | number : '1.1-1'
                      }}
                    </p>
                  </div>
                  <div class="stat-card-reporte">
                    ...
                    <p class="stat-valor">
                      {{ reporteActual.datos.doctoresHoy }}
                    </p>
                  </div>
                  <div class="stat-card-reporte">
                    <h4>🏥 Cobertura del Sistema</h4>
                    <p class="stat-valor">
                      {{ reporteActual.datos.porcentajeCobertura }}%
                    </p>
                ...
                <div class="ranking-especialidades">
                  ...
                  <div class="ranking-list">
                    <div
                      *ngFor="
                        let esp of reporteActual.datos.rankingEspecialidades;
                        let i = index
                      "
                      class="ranking-item"
                    >
                      ...
                      <span class="ranking-cantidad"
                        >{{ esp.doctores }} doctores</span
                      >
              ...
              <div *ngIf="reporteActual.tipo === 'citas'" class="reporte-citas">
                ...
                <div class="estadisticas-citas">
                  <div class="grid-stats">
                    <div class="stat-card-small">
                      ...
                      <span class="numero-stat-small">{{
                        reporteActual.datos.totalCitas
                      }}</span>
                    </div>
                    <div class="stat-card-small">
                      <small class="stat-label">📅 Hoy</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasHoy
                      }}</span>
                    </div>
                    <div class="stat-card-small">
                      <small class="stat-label">🔄 Pendientes</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasPendientes
                      }}</span>
                    </div>
                    <div class="stat-card-small">
                      <small class="stat-label">✅ Atendidas</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasAtendidas
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="lista-citas">
                  ...
                  <div class="tabla-container">
                    <table class="tabla-citas">
                      ...
                      <tbody>
                        <tr
                          *ngFor="let cita of reporteActual.datos.listaCitas"
                          [class]="
                            'estado-' +
                            cita.estado.toLowerCase().replace(' ', '-')
                          "
                        >
                          <td>{{ cita.id }}</td>
                          <td>{{ cita.fecha }}</td>
                ...
                <div class="citas-especialidad">
                  ...
                  <div class="especialidad-chart">
                    <div
                      *ngFor="
                        let esp of reporteActual.datos.citasPorEspecialidad
                      "
                      class="chart-bar"
                    >
                      ...
                      <div class="bar-container">
                        <div
                          class="bar-fill"
                          [style.width.%]="
                            (esp.cantidad / reporteActual.datos.totalCitas) *
                            100
                          "
                        >
                ...
                <div class="citas-estado">
                  ...
                  <div class="estado-grid">
                    <div
                      class="estado-card pendiente"
                      *ngIf="reporteActual.datos.citasPorEstado['Pendiente']"
                    >
                      <small class="stat-label">🔄 Pendientes</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasPorEstado['Pendiente']
                      }}</span>
                    </div>
                    <div
                      class="estado-card confirmada"
                      *ngIf="reporteActual.datos.citasPorEstado['Confirmada']"
                    >
                      <small class="stat-label">✅ Confirmadas</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasPorEstado['Confirmada']
                      }}</span>
                    </div>
                    <div
                      class="estado-card atendida"
                      *ngIf="reporteActual.datos.citasPorEstado['Atendida']"
                    >
                      <small class="stat-label">🩺 Atendidas</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasPorEstado['Atendida']
                      }}</span>
                    </div>
                    <div
                      class="estado-card cancelada"
                      *ngIf="reporteActual.datos.citasPorEstado['Cancelada']"
                    >
                      <small class="stat-label">❌ Canceladas</small>
                      <span class="numero-stat-small">{{
                        reporteActual.datos.citasPorEstado['Cancelada']
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div
                  ...
                  *ngIf="
                    ...
                    (reporteActual.filtros.fechaDesde ||
                      reporteActual.filtros.fechaHasta ||
                      reporteActual.filtros.especialidad ||
                      reporteActual.filtros.estado)
                  "
                >
                  <small class="stat-label">🔍 Filtros Aplicados</small>
                  <div class="filtro-info">
                    <span
                      *ngIf="reporteActual.filtros.fechaDesde"
                      class="filtro-tag"
                    >
                      📅 Desde: {{ reporteActual.filtros.fechaDesde }}
                    </span>
                    <span
                      *ngIf="reporteActual.filtros.fechaHasta"
                      class="filtro-tag"
                    >
                      📅 Hasta: {{ reporteActual.filtros.fechaHasta }}
                    </span>
                    <span
                      *ngIf="reporteActual.filtros.especialidad"
                      class="filtro-tag"
                    >
                      🏥 Especialidad: {{ reporteActual.filtros.especialidad }}
                    </span>
                    <span
                      *ngIf="reporteActual.filtros.estado"
                      class="filtro-tag"
                    >
            ...
            <div *ngIf="!reporteActual" class="sin-reporte">
              <div class="sin-reporte-content">
                ...
                <p>
                  Seleccione un tipo de reporte para generar consultas
                  detalladas del sistema.
                </p>
                <ul class="reportes-disponibles">
                  <li>
                    <strong>📈 Reporte General:</strong> Vista completa del
                    estado del sistema
                  </li>
                  <li>
                    <strong>👨‍⚕️ Reporte Doctores:</strong> Lista detallada de
                    todos los doctores
                  </li>
                  <li>
                    <strong>📅 Reporte Citas:</strong> Análisis de citas médicas
                    (próximamente)
                  </li>
                  <li>
                    <strong>📊 Estadísticas:</strong> Métricas y análisis
                    avanzados
                  </li>
                </ul>
              </div>
...
export class AdminSetupComponent implements OnInit {
  ...
  cargarDoctores() {
    ...
    this.http.get<Doctor[]>(`${BASE_API}/public/doctores`).subscribe({
      next: (doctores) => {
        this.doctores = doctores;
        this.doctoresFiltrados = [...doctores]; // Inicializar filtrados
        // Extraer correos y licencias existentes para validación
        this.correosExistentes = doctores.map((doctor) =>
          doctor.correo.toLowerCase()
        );
        this.licenciasExistentes = doctores.map((doctor) =>
          doctor.numeroLicencia.toLowerCase()
        );
  ...
  formatearTelefono() {
    ...
    if (telefono.length > 0) {
      ...
      if (telefono.length === 11 && telefono.startsWith('1')) {
        this.nuevoDoctor.telefono = `+${telefono.substring(
          0,
          1
        )} (${telefono.substring(1, 4)}) ${telefono.substring(
          4,
          7
  ...
  formatearLicencia() {
    ...
    if (
      licencia &&
      !licencia.startsWith('LIC-') &&
      !licencia.startsWith('MD-')
    ) {
      if (/^\d+$/.test(licencia)) {
  ...
  limpiarFormularioDoctor() {
    ...
    this.correosExistentes = this.doctores.map((doctor) =>
      doctor.correo.toLowerCase()
    );
    this.licenciasExistentes = this.doctores.map((doctor) =>
      doctor.numeroLicencia.toLowerCase()
    );
  }
  ...
  agregarEspecialidad() {
    ...
    const existeEspecialidad = this.especialidades.some(
      (esp) =>
        ...
        this.nuevaEspecialidad.nombre.trim().toLowerCase()
    );

    if (existeEspecialidad) {
      this.mostrarMensaje(
        'Esta especialidad ya está registrada en el sistema.',
        true
      );
      return;
    }
    ...
    this.http
      .post<Especialidad>(`${BASE_API}/especialidades`, especialidad)
      .subscribe({
        next: (nuevaEsp) => {
        ...
        error: (error) => {
          ...
          if (error.status === 0) {
            mensajeError =
              '❌ No se puede conectar al servidor. Verifique que el backend esté ejecutándose en el puerto 8081.';
          } else if (error.status === 400) {
            mensajeError =
              '❌ Datos inválidos: ' + (error.error?.message || error.message);
  ...
  agregarDoctor() {
    ...
    this.http.post<any>(`${BASE_API}/admin/doctores`, doctor).subscribe({
      next: (response) => {
      ...
      error: (error) => {
        ...
        this.mostrarMensaje(
          `Error al agregar doctor: ${error.error?.error || error.message}`,
          true
        );
      },
    });
  ...
  crearEspecialidad() {
    if (this.filtroEspecialidadSeleccionada) {
      ...
      const existeEspecialidad = this.especialidades.some(
        (esp) =>
          esp.nombre.toLowerCase() ===
          this.filtroEspecialidadSeleccionada!.toLowerCase()
      );
  ...
  toggleDoctorEstado(doctor: Doctor) {
    this.http
      .put<Doctor>(`${BASE_API}/doctores${doctor.id}/toggle-estado`, {})
      .subscribe({
        next: (doctorActualizado) => {
          ...
          const accion =
            doctorActualizado.estado === 'ACTIVO' ? 'activado' : 'desactivado';
          this.mostrarMensaje(
            `Doctor ${doctor.nombre} ${accion} exitosamente`,
            false
          );
        },
        error: (error) => {
          ...
          this.mostrarMensaje(
            'Error al cambiar el estado del doctor: ' +
              (error.error?.message || error.message),
            true
          );
        },
  ...
  eliminarDoctor(doctor: Doctor) {
    if (
      confirm(
        `¿Estás seguro de que deseas eliminar al doctor ${doctor.nombre}? Esta acción no se puede deshacer.`
      )
    ) {
      this.http.delete(`${BASE_API}/doctores${doctor.id}`).subscribe({
        next: () => {
          // Remover el doctor de la lista local
          this.doctores = this.doctores.filter((d) => d.id !== doctor.id);
          this.mostrarMensaje(
            `Doctor ${doctor.nombre} eliminado exitosamente`,
            false
          );
        },
        error: (error) => {
  ...
  filtrarDoctores() {
    ...
    if (this.filtroEspecialidadSeleccionada) {
      resultado = resultado.filter(
        (doctor) => doctor.especialidad === this.filtroEspecialidadSeleccionada
      );
    }
    ...
    if (this.filtroEstadoSeleccionado) {
      resultado = resultado.filter(
        (doctor) => doctor.estado === this.filtroEstadoSeleccionado
      );
    }
  ...
  generarReporteGeneral() {
    ...
    this.http.get<any>(`${BASE_API}/reportes/general`).subscribe({
      next: (response) => {
        if (response.success) {
          ...
          this.mostrarMensaje(
            '❌ Error al generar reporte: ' + response.message,
            true
          );
        }
      },
      error: (error) => {
        ...
        this.mostrarMensaje(
          '❌ Error de conexión al generar reporte general',
          true
        );
      },
    });
  ...
  generarReporteDoctores() {
    ...
    const url = `${BASE_API}/reportes/doctores${
    ...
    this.http.get<any>(url).subscribe({
      next: (response) => {
        if (response.success) {
          this.reporteActual = response;
          this.mostrarMensaje(
            `✅ Reporte de doctores generado: ${response.totalRegistros} registros`,
            false
          );
        } else {
          this.mostrarMensaje(
      ...
      error: (error) => {
        ...
        this.mostrarMensaje(
          '❌ Error de conexión al generar reporte de doctores',
          true
        );
      },
    });
  ...
  generarReporteCitas() {
    ...
    if (this.especialidadReporte && this.especialidadReporte.trim() !== '') {
      params.append('especialidad', this.especialidadReporte);
      console.log(
        '✅ Agregando filtro especialidad:',
        this.especialidadReporte
      );
    }
    ...
    const url = `${BASE_API}/reportes/citas${
      params.toString() ? '?' + params.toString() : ''
    }`;
    ...
    this.http.get<any>(url).subscribe({
      next: (response) => {
        if (response.success) {
          this.reporteActual = response;
          this.mostrarMensaje(
            '✅ Reporte de citas generado exitosamente',
            false
          );
        } else {
          this.mostrarMensaje(
      ...
      error: (error) => {
        ...
        this.mostrarMensaje(
          '❌ Error de conexión al generar reporte de citas',
          true
        );
      },
    });
  ...
  consultarEstadisticas() {
    ...
    this.http.get<any>(`${BASE_API}/reportes/estadisticas`).subscribe({
      next: (response) => {
        if (response.success) {
          this.reporteActual = response;
          ...
          this.mostrarMensaje(
            '❌ Error al generar estadísticas: ' + response.message,
            true
          );
        }
      },
      error: (error) => {
        ...
        this.mostrarMensaje(
          '❌ Error de conexión al generar estadísticas',
          true
        );
      },
    });
  ...
  private calcularEspecialidadesStats() {
    const stats = this.especialidades.map((esp) => {
      const doctores = this.doctores.filter(
        (d) => d.especialidad === esp.nombre
      ).length;
      return {
        nombre: esp.nombre,
        doctores: doctores,
  ...
  private calcularPorcentajeCobertura(): number {
    ...
    return Math.round(
      (especialidadesConDoctores / Math.max(this.especialidades.length, 1)) *
        100
    );
  }
